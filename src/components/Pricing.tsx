...
const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      price: "$29",
      period: "per month",
      description: "Ideal for growing businesses with advanced link management needs",
      features: [
        "Up to 25,000 links/month",
    ...
    },
    {
      name: "Enterprise",
      price: "Custom",
      description: "For large organizations with high-volume link management",
      features: [
        "Unlimited links",
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg">
            Scale your link management with plans that grow with your business
          </p>
        </div>
